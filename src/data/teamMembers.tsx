...
const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    instution: 'TU Delft',
    picture: require('./teamMembers/seyran-khademi.png').default,
  ...
  },
  {
    ...
    instution: 'TU Delft',
    picture: require('./teamMembers/burak-yildiz.png').default,
  ...
  },
  {
    ...
    instution: 'TU Delft',
    picture: require('./teamMembers/fatemeh-mostafavi.png').default,
  ...
  },
  {
    ...
    picture: require('./teamMembers/javier-cuartero.png').default,
